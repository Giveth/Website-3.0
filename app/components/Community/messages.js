 ...
 * Community Messages
 *
 * This contains all the text for the Community component.
 */
import { defineMessages } from 'react-intl';

export default defineMessages({
  header: {
    id: 'app.components.HomePage.Community.header',
    defaultMessage: 'Join the Giveth Community!',
  },
  communityText1: {
    id: 'app.components.HomePage.Community.communityText1',
    defaultMessage: 'We are actively seeking collaborators and like-minded, autonomous partners to make this vision a reality.',
  },
  communityText2a: {
