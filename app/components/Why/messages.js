...
export default defineMessages({
  header: {
    id: 'app.components.HomePage.Why.header',
    defaultMessage: 'Why Giveth?',
  },
  paragraph1: {
    id: 'app.components.HomePage.Why.paragraph1',
  ...
  paragraph2: {
    id: 'app.components.HomePage.Why.paragraph2',
  ...
  paragraph3: {
    id: 'app.components.HomePage.Why.paragraph3',
