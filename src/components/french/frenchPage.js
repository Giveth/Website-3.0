						...
						<div className="row separation intro">
							...
							<div className="col-xs-6">
								<div className="intro-text">
									<h1>Giveth</h1>
									<p>est une plateforme de smart contracts qui peut etre utilisée pour construire des<br/><strong>communautés</strong> autour des <strong>causes</strong> qui vous tiennent à coeur.</p>
								</div>
							</div>
						</div>
						<section className="row">
							<div className="col-xs-5">
								<h4>Le code open source de Giveth peut etre intégré dans n'importe quel projet basé sur les dons.</h4>
								<p>Les ONG globales comme les petites équipes de développement open source peuvent utiliser le code et la culture de Giveth pour amener plus de <strong>transparence, responsabilité et confiance</strong> à leur communauté de Donateurs et de Créateurs de Changement, en s'appuyant sur la<strong> Blockchain Ethereum</strong>.</p>
							</div>
							<div className="col-xs-7">
								<img src="images/current_charity__2_.png" className="infographic" alt="Modèle de dons actuel"/>
							</div>
						</section>
						<section>
