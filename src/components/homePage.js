						...
						<div className="row">
							...
							<div className="col-xs-12 col-md-6 explanation-paragraph">
								<div className="ep1">
									...
									<p>The traditional charitable system has undergone a slow evolution. It is out of date and out of touch. Too often it provides short-term, one-size-fits-all solutions that fail to address the root causes of the problems they are trying to solve.</p>
								</div>
							</div>
						</div>
						<div className="row">
